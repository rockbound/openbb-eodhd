"""Fetcher for fundamentals — generated from spec.

Hits ``https://eodhd.com/api/fundamentals/{ticker}`` via HTTP GET.
"""
...
class FundamentalsQueryParams(QueryParams):
    """Query parameters for fundamentals.
...
class FundamentalsFetcher(Fetcher[FundamentalsQueryParams, list[FundamentalsData]]):
    ...
    async def aextract_data(
        query: FundamentalsQueryParams,
        credentials: dict[str, str] | None,
        **kwargs: Any,
    ) -> dict[str, Any]:
        """Fetch from https://eodhd.com/api/fundamentals/{ticker} and split rows from metadata.
        ...
        **kwargs : Any
        ...
        _path = f"/fundamentals/{query.ticker}"
    ...
    def transform_data(
        ...
        data: dict[str, Any],
        **kwargs: Any,
    ) -> list[FundamentalsData] | AnnotatedResult[list[FundamentalsData]]:
        """Type the unpacked rows as FundamentalsData; surface metadata via AnnotatedResult.
        ...
        **kwargs : Any
        ...
        """
        _typed = [FundamentalsData(**row) for row in data["rows"]]
