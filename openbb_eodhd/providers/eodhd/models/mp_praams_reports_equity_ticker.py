"""Fetcher for mp.praams.reports.equity.ticker — generated from spec.

Hits ``https://eodhd.com/api/mp/praams/reports/equity/ticker/{ticker}`` via HTTP GET.
"""
...
class MpPraamsReportsEquityTickerQueryParams(QueryParams):
    """Query parameters for mp.praams.reports.equity.ticker.
    ...
    ticker: str = Field(description="Ticker symbol (e.g., 'AAPL.US').")
...
class MpPraamsReportsEquityTickerDataRiskSummary(BaseModel):
    """MpPraamsReportsEquityTickerDataRiskSummary.
...
class MpPraamsReportsEquityTickerDataEquityDetails(BaseModel):
    """MpPraamsReportsEquityTickerDataEquityDetails.
...
class MpPraamsReportsEquityTickerDataPerformance(BaseModel):
    """MpPraamsReportsEquityTickerDataPerformance.
...
class MpPraamsReportsEquityTickerData(Data):
    """Response row for mp.praams.reports.equity.ticker.
    ...
    risk_summary : MpPraamsReportsEquityTickerDataRiskSummary, optional
        Inner fields: risk_score (float), risk_category (str), volatility_risk (str), market_risk (str).
    equity_details : MpPraamsReportsEquityTickerDataEquityDetails, optional
        Inner fields: sector (str), market_cap (float), beta (float), pe_ratio (float), dividend_yield (float).
    performance : MpPraamsReportsEquityTickerDataPerformance, optional
    ...
    risk_summary: MpPraamsReportsEquityTickerDataRiskSummary | None = Field(
        default=None,
        description="Inner fields: risk_score (float), risk_category (str), volatility_risk (str), market_risk (str).",
    )
    equity_details: MpPraamsReportsEquityTickerDataEquityDetails | None = Field(
        default=None,
        description="Inner fields: sector (str), market_cap (float), beta (float), pe_ratio (float), dividend_yield (float).",
    )
    performance: MpPraamsReportsEquityTickerDataPerformance | None = Field(
        default=None,
...
class MpPraamsReportsEquityTickerFetcher(
    Fetcher[MpPraamsReportsEquityTickerQueryParams, list[MpPraamsReportsEquityTickerData]]
):
    """Returns a comprehensive PRAAMS report for a specific equity, including risk assessment and analytics."""

    @staticmethod
    def transform_query(params: dict[str, Any]) -> MpPraamsReportsEquityTickerQueryParams:
        ...
        Returns
        -------
        MpPraamsReportsEquityTickerQueryParams
            Validated query parameters.
        """
        return MpPraamsReportsEquityTickerQueryParams(**params)

    @staticmethod
    async def aextract_data(
        query: MpPraamsReportsEquityTickerQueryParams,
        credentials: dict[str, str] | None,
        **kwargs: Any,
    ) -> dict[str, Any]:
        """Fetch from https://eodhd.com/api/mp/praams/reports/equity/ticker/{ticker} and split rows from metadata.
        ...
        **kwargs : Any
        ...
        _path = f"/mp/praams/reports/equity/ticker/{query.ticker}"
    ...
    def transform_data(
        ...
        **kwargs: Any,
        ...
        list[MpPraamsReportsEquityTickerData]
        | AnnotatedResult[list[MpPraamsReportsEquityTickerData]]
    ):
        """Type the unpacked rows as MpPraamsReportsEquityTickerData; surface metadata via AnnotatedResult.
        ...
        **kwargs : Any
        ...
        Returns
        -------
        list[MpPraamsReportsEquityTickerData] | AnnotatedResult[list[MpPraamsReportsEquityTickerData]]
            Typed rows; wrapped in ``AnnotatedResult`` when the response carried metadata alongside the data array.
        """
        _typed = [MpPraamsReportsEquityTickerData(**row) for row in data["rows"]]
