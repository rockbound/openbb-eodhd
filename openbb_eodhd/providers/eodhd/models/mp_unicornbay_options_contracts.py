"""Fetcher for mp.unicornbay.options.contracts — generated from spec.

Hits ``https://eodhd.com/api/mp/unicornbay/options/contracts`` via HTTP GET.
"""
...
class MpUnicornbayOptionsContractsQueryParams(QueryParams):
    """Query parameters for mp.unicornbay.options.contracts.
    ...
    fields_options_contracts_ : str, optional
    ...
    fields_options_contracts_: str | None = Field(
        default=None,
        alias="fields[options-contracts]",
...
class MpUnicornbayOptionsContractsDataAttributes(BaseModel):
...
class MpUnicornbayOptionsContractsData(Data):
    """Response row for mp.unicornbay.options.contracts.

    Parameters
    ----------
    id : str
    type : Literal['options-contracts']
        Choices: options-contracts.
    attributes : MpUnicornbayOptionsContractsDataAttributes
    ...
    type: Literal["options-contracts"] = Field(
        description="Choices: options-contracts.",
    )
    attributes: MpUnicornbayOptionsContractsDataAttributes = Field(
        description="Common fields for options contract/EOD records. Values may be null. Inner fields: contract (str), underlying_symbol (str), exp_date (str), expiration_type (Any), type (str), strike (Any), exchange (Any), currency (Any), open (Any), high (Any), low (Any), last (Any), last_size (Any), change (Any), pctchange (Any), previous (Any), previous_date (Any), bid (Any), bid_date (Any), bid_size (Any), ask (Any), ask_date (Any), ask_size (Any), moneyness (Any), volume (Any), volume_change (Any), volume_pctchange (Any), open_interest (Any), open_interest_change (Any), open_interest_pctchange (Any), volatility (Any), volatility_change (Any), volatility_pctchange (Any), theoretical (Any), delta (Any), gamma (Any), theta (Any), vega (Any), rho (Any), tradetime (Any), vol_oi_ratio (Any), dte (Any), midpoint (Any).",
    )


class MpUnicornbayOptionsContractsFetcher(
    Fetcher[MpUnicornbayOptionsContractsQueryParams, list[MpUnicornbayOptionsContractsData]]
):
    ...
    @staticmethod
    def transform_query(params: dict[str, Any]) -> MpUnicornbayOptionsContractsQueryParams:
        ...
        Returns
        -------
        MpUnicornbayOptionsContractsQueryParams
            Validated query parameters.
        """
        return MpUnicornbayOptionsContractsQueryParams(**params)

    @staticmethod
    async def aextract_data(
        query: MpUnicornbayOptionsContractsQueryParams,
        credentials: dict[str, str] | None,
        **kwargs: Any,
    ) -> dict[str, Any]:
        """Fetch from https://eodhd.com/api/mp/unicornbay/options/contracts and split rows from metadata.
        ...
        **kwargs : Any
        ...
        _path = "/mp/unicornbay/options/contracts"
    ...
    def transform_data(
        ...
        **kwargs: Any,
        ...
        list[MpUnicornbayOptionsContractsData]
        | AnnotatedResult[list[MpUnicornbayOptionsContractsData]]
    ):
        """Type the unpacked rows as MpUnicornbayOptionsContractsData; surface metadata via AnnotatedResult.
        ...
        **kwargs : Any
        ...
        Returns
        -------
        list[MpUnicornbayOptionsContractsData] | AnnotatedResult[list[MpUnicornbayOptionsContractsData]]
            Typed rows; wrapped in ``AnnotatedResult`` when the response carried metadata alongside the data array.
        """
        _typed = [MpUnicornbayOptionsContractsData(**row) for row in data["rows"]]
