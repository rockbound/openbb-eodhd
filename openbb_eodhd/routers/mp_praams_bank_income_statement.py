"""Router for mp.praams.bank.income_statement commands — generated from spec."""
...
@router.command(model="MpPraamsBankIncomeStatementIsin")
async def isin(
    cc: CommandContext,
...
@router.command(model="MpPraamsBankIncomeStatementTicker")
async def ticker(
    cc: CommandContext,
    provider_choices: ProviderChoices,
    standard_params: StandardParams,
